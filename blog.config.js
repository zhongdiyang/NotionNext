...
const BLOG = {
  ...
  // https://zhongdiyang.notion.site/zhongdiyang/5e2221726dbc4ac386c443ed49d9c20f
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '5e2221726dbc4ac386c443ed49d9c20f',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zdy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zhongdiyang.notion.site/zhongdiyang/Bolg-1308dd252ca849cd859997cebed12a7a', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '程序猿zdy的博客', // 网站关键词 英文逗号隔开
